    ...
    <div className="h-full overflow-y-auto p-5 sm:p-8">
      <div className="mx-auto max-w-6xl">
        <header className="flex flex-wrap items-end justify-between gap-4">
          <div><p className="text-xs font-bold uppercase tracking-[.14em] text-primary">Bid preparation</p><h1 className="mt-1 text-2xl font-bold">Document Filler</h1><p className="mt-1 text-sm text-muted-foreground">Edit tender working copies with your team and Dora.</p></div>
